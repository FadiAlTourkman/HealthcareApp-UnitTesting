...
//     */ 
    ...
    public void testSetDoctorsFields() {
        ...
        instance.setDoctorsFields(email);
...
//     */ 
    ...
    public void testUpdateExistingPrescription() {
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery(
                    "select MedicationDatePrescribed from MedicationPrescribed where MedicationDatePrescribed='"
                    + newMedicationDay + "';");
...
//     */ 
    ...
    public void testRegisterCompletedProcedure() {
        ...
        try {
            ...
            procedure.setProcedureId("PC-4000000");
            ...
            ResultSet rs = stmt.executeQuery(
                    "select ProcedureCompletedId from ProceduresCompleted where ProcedureCompletedId='"
                    + "PC-4000000" + "';");
            ...
            while (rs.next()) {
                ...
                if ("PC-4000000".equals(rs.getString(1))) {
...
////     */ 
    ...
    public void testAddNewAPpointment() {
        ...
        try {
            ...
            appointment.setAppointmentSummary("The patient healing very well to Cardiac Ablation procedue. Appointment made to be made for in 18 months time. Tube integrity obsevation required.");
...
//     */ 
    ...
    public void testUpdateExistingHospitalAppointment() {
        ...
        try {
            ...
            String newAppointmentDate = "The patient healing very well to Cardiac Ablation procedue. Appointment made to be made for in 18 months time. Tube integrity obsevation required.";
            ...
            appointment.setAppointmentId("AP-3999999");
...
//     */ 
    ...
    public void testUpdateExistingSurgeryAppointment() {
        ...
        try {
            ...
            appointment.setAppointmentSummary("Patient complaining of chest pains. Refering to cardiac secialist in Beaumont hospital. Urgent attention required");
            ...
            while (rs.next()) {
                ...
                if ("12/05/2023".equals(rs.getString(1))) {
